...
- [x] `CNT-001` Glossaire relié aux infobulles — `feat/CNT-001-glossaire`
      ...
      d'infobulle (ADR-008), et l'ancre d'un terme se **calcule** aux deux bouts
      (ADR-009). Chaque bulle porte un lien vers son entrée ; le rendre atteignable a
...
contenus. C'est la séparation qui l'emporte, et la raison est écrite en ADR-008 : un
