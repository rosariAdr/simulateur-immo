...
/** Une fourchette « 7,0 % à 8,5 % », telle que `params.ts` les exprime. */
...
export const VALEURS = {
  ...
  tauxGroupe: fourchette(P.borrowerInsurance.marketGroupRatePct, 2),
  tauxDelegation: fourchette(P.borrowerInsurance.marketDelegationRatePct, 2),

  /* Garanties. */
  coutCaution: formatPourcentage(P.guarantee.suretyshipCostPct, 2),
  restitutionCaution: formatPourcentage(P.guarantee.suretyshipRefundPct, 1),
  coutHypotheque: formatPourcentage(P.guarantee.mortgageCostPct, 2),
  coutMainlevee: formatPourcentage(P.guarantee.mortgageReleasePct, 2),
  coutNantissement: formatPourcentage(P.guarantee.pledgeCostPct, 2),
  ...
  fraisAncien: fourchette(P.transferTax.totalFeesOldPct, 1),
  fraisNeuf: fourchette(P.transferTax.totalFeesNewPct, 1),
