...
export const ASSURANCE = {
  ...
  /** Fourchettes de marché, indicatives et non réglementaires. */
  fourchetteGroupePct: PARAMS.borrowerInsurance.marketGroupRatePct,
  fourchetteDelegationPct: PARAMS.borrowerInsurance.marketDelegationRatePct,
...
const comparer = (cle: GuaranteeKind): GarantieComparee => {
  const g = guaranteeCost(cle, PLAN.totalPrincipal, ENTREE_REFERENCE.propertyPrice, PARAMS);
  return {
    cle,
